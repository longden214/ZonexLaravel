    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
               ...
               <div class="box-body">
                <form action="{{route('admin.banner.update',$bn->id)}}" method="POST" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    @method('PUT')
					<div class="row">
                        <div class="col-md-6">
                            <div class="form-group @error('image') has-error @enderror">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="image" name="image" value="{{$bn->image}}">
						...
						<div class="col-md-6">
							<div class="form-group @error('sort') has-error @enderror">
								...
								<input type="text" class="form-control"  name="sort" value="{{$bn->sort}}">
								@error('sort')
								    <small class="error help-block">{{$message}}</small>
								@enderror()
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control"  name="slogan" value="{{$bn->slogan}}">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="">Caption</label>
								<input type="text" class="form-control" name="caption" value="{{$bn->caption}}">
							</div>
						</div>
					</div>
